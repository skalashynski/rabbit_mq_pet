...
import com.skalashynski.rabbitmq.converter.ProductToProductForm;
import com.skalashynski.rabbitmq.entity.Product;
import com.skalashynski.rabbitmq.service.ProductService;
...
public class ProductController {
    ...
    public String getProduct(@PathVariable String id, Model model) {
        productService
                ...
                .ifPresent(e -> model.addAttribute("product", e));
    ...
    public String edit(@PathVariable String id, Model model) {
        ...
        product.ifPresent(productForm -> {
            productToProductForm.convert(productForm);
